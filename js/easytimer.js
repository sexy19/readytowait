!function() {
    ...
    o.prototype.toString = function() {
        ...
        for (i = 0; i < e.length; i += 1)
            void 0 !== this[e[i]] && ("secondTenths" === e[i] ? o.push(this[e[i]]) : o.push(r(this[e[i]], n, "0")));
        return o.join(t)
    }
    ,
    ...
    function m() {
        var e, i, r, m, v, y, b, _, w, x, T = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, E = new o, A = new o, k = new s, C = !1, S = !1, O = {}, D = {
            detail: {
                timer: this
            }
        };
        function j(e, t) {
            ...
            return function(e, t) {
                var n = p[e];
                A[e] = t,
                E[e] = e === d ? Math.abs(t) : g(t >= 0 ? t : n - g(t, n), n)
            }(t, W(e, h[t])),
            A[t] !== n
        }
        function L() {
        ...
        function $() {
            return M(Date.now()) - A.secondTenths * h[a] * r
        }
        function F() {
            var e = M(Date.now());
            !function(e) {
                e[a] && Y("secondTenthsUpdated", D);
                e[l] && Y("secondsUpdated", D);
                e[c] && Y("minutesUpdated", D);
                e[u] && Y("hoursUpdated", D);
                e[d] && Y("daysUpdated", D)
            }(I()),
            m(D.detail.timer),
            H(e) && (z(),
        ...
        function I() {
            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : M(Date.now())
              , t = r > 0 ? e - w : w - e
              , n = {};
            return n[a] = j(t, a),
            n[l] = function(e) {
        ...
        function M(e) {
            return Math.floor(e / h[i]) * h[i]
        }
        function H(e) {
            return y instanceof Array && e >= x
        }
        function q(e) {
            var t;
            i = function(e) {
                if (e = "string" == typeof e ? e : l,
                !function(e) {
            ...
            m = "function" == typeof e.callback ? e.callback : function() {}
            ,
            _ = !0 === e.countdown,
            r = !0 === _ ? -1 : 1,
            "object" === n(e.startValues) ? (t = e.startValues,
            b = R(t),
            E.secondTenths = b[0],
            E.seconds = b[1],
            E.minutes = b[2],
            ...
            w = $(),
            I(),
            "object" === n(e.target) ? y = B(e.target) : _ ? (e.target = {
                seconds: 0
            },
            y = B(e.target)) : y = null,
            O = {
        ...
        function B(e) {
            if (e) {
                var t = V(y = R(e));
                return x = w + t.secondTenths * h[a] * r,
                y
            }
        }
        function V(e, t) {
   ...
   */
    b = _,
    function(e, t) {
        b.exports = e.document ? t(e, !0) : function(e) {
            if (!e.document)
                throw new Error("jQuery requires a window with a document");
            return t(e)
        }
    }("undefined" != typeof window ? window : v, (function(e, t) {
        var n = []
        ...
        x.extend = x.fn.extend = function() {
            ...
            a--); a < l; a++)
                if (null != (e = arguments[a]))
                    for (t in e)
                        i = e[t],
                        "__proto__" !== t && s !== i && (c && i && (x.isPlainObject(i) || (r = Array.isArray(i))) ? (n = s[t],
        ...
        x.extend({
            ...
            makeArray: function(e, t) {
                var n = t || [];
                return null != e && (T(Object(e)) ? x.merge(n, "string" == typeof e ? [e] : e) : s.call(n, e)),
                n
            },
        ...
        var L = m
          , P = s;
        !function() {
            var t, i, o, s, l, c, d, f, p, g, m = P, v = x.expando, y = 0, b = 0, _ = ee(), w = ee(), T = ee(), D = ee(), j = function(e, t) {
                return e === t && (l = !0),
                0
            }, N = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", $ = "(?:\\\\[\\da-fA-F]{1,6}" + S + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", F = "\\[" + S + "*(" + $ + ")(?:" + S + "*([*^$|!~]?=)" + S + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + $ + "))|)" + S + "*\\]", I = ":(" + $ + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + F + ")*)|.*)\\)|)", M = new RegExp(S + "+","g"), H = new RegExp("^" + S + "*," + S + "*"), q = new RegExp("^" + S + "*([>+~]|" + S + ")" + S + "*"), R = new RegExp(S + "|>"), W = new RegExp(I), B = new RegExp("^" + $ + "$"), V = {
                ID: new RegExp("^#(" + $ + ")"),
                CLASS: new RegExp("^\\.(" + $ + ")"),
                TAG: new RegExp("^(" + $ + "|[*])"),
                ATTR: new RegExp("^" + F),
            ...
            }, z = /^(?:input|select|textarea|button)$/i, U = /^h\d$/i, X = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, Y = /[+~]/, Q = new RegExp("\\\\[\\da-fA-F]{1,6}" + S + "?|\\\\([^\\r\\n\\f])","g"), K = function(e, t) {
            ...
            try {
                m.apply(n = r.call(L.childNodes), L.childNodes),
                ...
                m = {
                    ...
                    call: function(e) {
                        P.apply(e, r.call(arguments, 1))
                    }
                }
            }
            function J(e, t, n, i) {
                var r, o, s, a, l, u, d, g = t && t.ownerDocument, y = t ? t.nodeType : 9;
                if (n = n || [],
                ...
                f)) {
                        ...
                        if (r = l[1]) {
                            if (9 === y) {
                                ...
                                if (s.id === r)
                                    return m.call(n, s),
                                    n
                            } else if (g && (s = g.getElementById(r)) && J.contains(t, s) && s.id === r)
                                return m.call(n, s),
                                n
                        } else {
                            if (l[2])
                    ...
                    if (!(D[e + " "] || p && p.test(e))) {
                        if (d = e,
                        g = t,
                        1 === y && (R.test(e) || q.test(e))) {
                            for ((g = Y.test(e) && ae(t.parentNode) || t) == t && h.scope || ((a = t.getAttribute("id")) ? a = x.escapeSelector(a) : t.setAttribute("id", a = v)),
                            o = (u = ue(e)).length; o--; )
            ...
            function le(e) {
                ...
                d.msMatchesSelector && L != c && (t = c.defaultView) && t.top !== t && t.addEventListener("unload", G),
                ...
                ne((function(e) {
                    ...
                    e.querySelectorAll("[selected]").length || p.push("\\[" + S + "*(?:value|" + N + ")"),
                ...
                j = function(e, t) {
                    ...
                    return n || (1 & (n = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !h.sortDetached && t.compareDocumentPosition(e) === n ? e === c || e.ownerDocument == L && J.contains(L, e) ? -1 : t === c || t.ownerDocument == L && J.contains(L, t) ? 1 : s ? a.call(s, e) - a.call(s, t) : 0 : 4 & n ? -1 : 1)
                }
                ,
                c) : c
            }
            ...
            J.attr = function(e, t) {
                ...
                var n = i.attrHandle[t.toLowerCase()]
                  , r = n && u.call(i.attrHandle, t.toLowerCase()) ? n(e, t, !f) : void 0;
            ...
            i = x.expr = {
                ...
                preFilter: {
                    ...
                    PSEUDO: function(e) {
                        var t, n = !e[6] && e[2];
                        return V.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && W.test(n) && (t = ue(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                        e[2] = n.slice(0, t)),
                        e.slice(0, 3))
                    }
                },
                filter: {
                    ...
                    ATTR: function(e, t, n) {
                        return function(i) {
                            var r = J.attr(i, e);
                            return null == r ? "!=" === t : !t || (r += "",
                            "=" === t ? r === n : "!=" === t ? r !== n : "^=" === t ? n && 0 === r.indexOf(n) : "*=" === t ? n && r.indexOf(n) > -1 : "$=" === t ? n && r.slice(-n.length) === n : "~=" === t ? (" " + r.replace(M, " ") + " ").indexOf(n) > -1 : "|=" === t && (r === n || r.slice(0, n.length + 1) === n + "-"))
                        }
                    },
                    CHILD: function(e, t, n, i, r) {
                        ...
                        : function(t, n, l) {
                            ...
                            if (g) {
                                ...
                                !1 === _)
                                    for (; (d = ++f && d && d[p] || (_ = f = 0) || h.pop()) && (!(a ? E(d, m) : 1 === d.nodeType) || !++_ || (b && ((u = d[v] || (d[v] = {}))[e] = [y, _]),
                                    d !== t)); )
                                        ;
            ...
            function ue(e, t) {
                ...
                l = [],
                c = i.preFilter; a; ) {
                    for (s in n && !(r = H.exec(a)) || (r && (a = a.slice(r[0].length) || a),
                    l.push(o = [])),
                    n = !1,
            ...
            function ge(e, t, n, i, r, o) {
                ...
                te((function(o, s, l, c) {
                    ...
                    if (n ? n(b, h = r || (o ? e : v || i) ? [] : s, l, c) : h = b,
                    i)
                        for (u = pe(h, g),
                        i(u, [], l, c),
                        d = u.length; d--; )
                    ...
                    if (o) {
                        if (r || e) {
                            ...
                            for (d = h.length; d--; )
                                (f = h[d]) && (u = r ? a.call(o, f) : p[d]) > -1 && (o[u] = !(s[u] = f))
                        }
                    } else
                        h = pe(h === s ? h.splice(v, h.length) : h),
                        r ? r(null, s, h, c) : m.apply(s, h)
                }
                ))
            }
            function me(e) {
                for (var t, n, r, s = e.length, l = i.relative[e[0].type], c = l || i.relative[" "], u = l ? 1 : 0, d = fe((function(e) {
                    return e === t
                }
                ), c, !0), f = fe((function(e) {
                    return a.call(t, e) > -1
                    ...
                    var r = !l && (i || n != o) || ((t = n).nodeType ? d(e, n, i) : f(e, n, i));
                    return t = null,
                    r
                }
                ]; u < s; u++)
                    if (n = i.relative[e[u].type])
                        ...
                        if ((n = i.filter[e[u].type].apply(null, e[u].matches))[v]) {
                            ...
                            return ge(u > 1 && he(h), u > 1 && de(e.slice(0, u - 1).concat({
                                value: " " === e[u - 2].type ? "*" : ""
                            })).replace(O, "$1"), n, u < r && me(e.slice(u, r)), r < s && me(e = e.slice(r)), r < s && de(e))
                        }
                        h.push(n)
                    }
                return he(h)
            ...
            function ve(e, t) {
                ...
                if (!a) {
                    for (t || (t = ue(e)),
                    n = t.length; n--; )
                        (a = me(t[n]))[v] ? r.push(a) : s.push(a);
                    a = T(e, function(e, t) {
                        var n = t.length > 0
                          , r = e.length > 0
                          , s = function(s, a, l, u, d) {
                            var h, p, g, v = 0, b = "0", _ = s && [], w = [], T = o, E = s || r && i.find.TAG("*", d), k = y += null == T ? 1 : Math.random() || .1, C = E.length;
                            for (d && (o = a == c || a || d); b !== C && null != (h = E[b]); b++) {
                                if (r && h) {
                                    for (p = 0,
            ...
            function ye(e, t, n, r) {
                var o, s, a, l, c, u = "function" == typeof e && e, d = !r && ue(e = u.selector || e);
                if (n = n || [],
                1 === d.length) {
                    if ((s = d[0] = d[0].slice(0)).length > 2 && "ID" === (a = s[0]).type && 9 === t.nodeType && f && i.relative[s[1].type]) {
                        if (!(t = (i.find.ID(a.matches[0].replace(Q, K), t) || [])[0]))
                            return n;
                        u && (t = t.parentNode),
                        e = e.slice(s.shift().value.length)
                    }
                    for (o = V.needsContext.test(e) ? 0 : s.length; o-- && (a = s[o],
                    !i.relative[l = a.type]); )
                        if ((c = i.find[l]) && (r = c(a.matches[0].replace(Q, K), Y.test(s[0].type) && ae(t.parentNode) || t))) {
                            if (s.splice(o, 1),
                            !(e = r.length && de(s)))
                                return m.apply(n, r),
                                n;
                ...
                return (u || ve(e, d))(r, t, !f, n, !t || Y.test(e) && ae(t.parentNode) || t),
                n
            }
            ce.prototype = i.filters = i.pseudos,
            i.setFilters = new ce,
            h.sortStable = v.split("").sort(j).join("") === v,
            le(),
        ...
        x.fn.extend({
            ...
            is: function(e) {
                return !!M(this, "string" == typeof e && F.test(e) ? x(e) : e || [], !1).length
            }
        });
        var H, q = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
        ...
        x.each({
            ...
            x.fn[e] = function(n, i) {
                ...
                this.length > 1 && (W[e] || x.uniqueSort(r),
                R.test(e) && r.reverse()),
                this.pushStack(r)
            }
        }
        ...
        x.Callbacks = function(e) {
            e = "string" == typeof e ? function(e) {
                var t = {};
                return x.each(e.match(V) || [], (function(e, n) {
                    t[n] = !0
                }
                )),
                t
                ...
                add: function() {
                    ...
                    function t(n) {
                        x.each(n, (function(n, i) {
                            p(i) ? e.unique && c.has(i) || o.push(i) : i && i.length && "string" !== b(i) && t(i)
                        }
                        ))
                    }(arguments),
                    n && !t && l()),
                  ...
                  , r = {
                    ...
                    then: function(t, i, r) {
                                ...
                                var a = this
                                  ...
                                  , c = function() {
                                    ...
                                    if (!(t < o)) {
                                        ...
                                        p(c) ? r ? c.call(e, s(o, n, z, r), s(o, n, U, r)) : (o++,
                                        c.call(e, s(o, n, z, r), s(o, n, U, r), s(o, n, z, n.notifyWith))) : (i !== z && (a = void 0,
                                        l = [e]),
                                        (r || n.resolveWith)(a, l))
                                    }
                                }
                        ...
                        return x.Deferred((function(e) {
                            n[0][3].add(s(0, e, p(r) ? r : z, e.notifyWith)),
                            n[1][3].add(s(0, e, p(t) ? t : z)),
                            n[2][3].add(s(0, e, p(i) ? i : U))
                        }
                        )).promise()
                    },
                    promise: function(e) {
        ...
        x.ready.then = Q.then,
        "complete" === m.readyState || "loading" !== m.readyState && !m.documentElement.doScroll ? e.setTimeout(x.ready) : (m.addEventListener("DOMContentLoaded", K),
        ...
        ie.prototype = {
            ...
            remove: function(e, t) {
                ...
                if (void 0 !== i) {
                    if (void 0 !== t) {
                        n = (t = Array.isArray(t) ? t.map(te) : (t = te(t))in i ? [t] : t.match(V) || []).length;
                        for (; n--; )
                            delete i[t[n]]
                    }
        ...
        x.fn.extend({
            data: function(e, t) {
                ...
                if (void 0 === e) {
                    if (this.length && (r = oe.get(o),
                    1 === o.nodeType && !re.get(o, "hasDataAttrs"))) {
                        for (n = s.length; n--; )
                            s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = te(i.slice(5)),
                            le(o, i, r[i]));
        ...
        x.fn.extend({
            ...
            promise: function(e, t) {
                ...
                e = void 0),
                e = e || "fx"; s--; )
                    (n = re.get(o[s], e + "queueHooks")) && n.empty && (i++,
                    n.empty.add(a));
                return a(),
                r.promise(t)
            }
        ...
        function be(e, t) {
            for (var n, i, r = [], o = 0, s = e.length; o < s; o++)
                ...
                t ? ("none" === n && (r[o] = re.get(i, "display") || null,
                r[o] || (i.style.display = "")),
                "" === i.style.display && ge(i) && (r[o] = ye(i))) : "none" !== n && (r[o] = "none",
                re.set(i, "display", n)));
            for (o = 0; o < s; o++)
        ...
        var _e, we, xe = /^(?:checkbox|radio)$/i, Te = /<([a-z][^\/\0>\x20\t\r\n\f]*)/i, Ee = /^$|^module$|\/(?:java|ecma)script/i;
        ...
        Ae.th = Ae.td,
        h.option || (Ae.optgroup = Ae.option = [1, "<select multiple='multiple'>", "</select>"]);
        var Se = /<|&#?\w+;/;
        ...
        function Ne(e, t, n) {
            ...
            })) : void 0 === re.get(e, t) && x.event.add(e, t, je)
        }
        x.event = {
            global: {},
            add: function(e, t, n, i, r) {
                var o, s, a, l, c, u, d, f, h, p, g, m = re.get(e);
                if (ne(e))
                    for (n.handler && (n = (o = n).handler,
                    r = o.selector),
                    r && x.find.matchesSelector(fe, r),
            ...
            remove: function(e, t, n, i, r) {
                var o, s, a, l, c, u, d, f, h, p, g, m = re.hasData(e) && re.get(e);
                if (m && (l = m.events)) {
                    for (c = (t = (t || "").match(V) || [""]).length; c--; )
                        if (h = g = (a = De.exec(t[c]) || [])[1],
                        p = (a[2] || "").split(".").sort(),
                        h) {
            ...
            dispatch: function(e) {
                var t, n, i, r, o, s, a = new Array(arguments.length), l = x.event.fix(e), c = (re.get(this, "events") || Object.create(null))[l.type] || [], u = x.event.special[l.type] || {};
                for (a[0] = l,
                ...
                if (l && c.nodeType && !("click" === e.type && e.button >= 1))
                    for (; c !== this; c = c.parentNode || this)
                        if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                            ...
                            s = {},
                            n = 0; n < l; n++)
                                void 0 === s[r = (i = t[n]).selector + " "] && (s[r] = i.needsContext ? x(r, this).index(c) > -1 : x.find(r, this, null, [c]).length),
                                s[r] && o.push(i);
                            o.length && a.push({
                                elem: c,
                                handlers: o
            ...
            special: {
                ...
                click: {
                    setup: function(e) {
                        var t = this || e;
                        return xe.test(t.type) && t.click && E(t, "input") && Ne(t, "click", !0),
                        !1
                    },
                    trigger: function(e) {
                        var t = this || e;
                        return xe.test(t.type) && t.click && E(t, "input") && Ne(t, "click"),
                        !0
                    },
                    _default: function(e) {
                        var t = e.target;
        ...
        x.Event = function(e, t) {
            ...
            this.type = e.type,
            this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? je : Le,
            ...
            x.event.special[t] = {
                setup: function() {
                    var i = this.ownerDocument || this.document || this
                      , r = m.documentMode ? this : i
                      , o = re.get(r, t);
                    o || (m.documentMode ? this.addEventListener(t, n) : i.addEventListener(e, n, !0)),
                    re.set(r, t, (o || 0) + 1)
                },
                teardown: function() {
                    var i = this.ownerDocument || this.document || this
                      , r = m.documentMode ? this : i
                      , o = re.get(r, t) - 1;
                    o ? re.set(r, t, o) : (m.documentMode ? this.removeEventListener(t, n) : i.removeEventListener(e, n, !0),
                    re.remove(r, t))
                }
            }
        }
        ...
        function Be(e, t, n, i) {
            t = o(t);
            var r, s, a, l, c, u, d = 0, f = e.length, g = f - 1, m = t[0], v = p(m);
            ...
            if (f && (s = (r = Oe(t, e[0].ownerDocument, !1, e, i)).firstChild,
            1 === r.childNodes.length && (r = s),
            s || i)) {
                for (l = (a = x.map(ke(r, "script"), He)).length; d < f; d++)
                    c = r,
                    d !== g && (c = x.clone(c, !0, !0),
                    l && x.merge(a, ke(c, "script"))),
                    n.call(e[d], c, d);
                if (l)
                    ...
                    d = 0; d < l; d++)
                        ...
                        }, u) : y(c.textContent.replace(Ie, ""), c, u))
            }
            return e
        }
        function Ve(e, t, n) {
            for (var i, r = t ? x.filter(t, e) : e, o = 0; null != (i = r[o]); o++)
                n || 1 !== i.nodeType || x.cleanData(ke(i)),
                i.parentNode && (n && he(i) && Ce(ke(i, "script")),
            ...
            clone: function(e, t, n) {
                ...
                if (t)
                    if (n)
                        ...
                        Re(e, a);
                return (s = ke(a, "script")).length > 0 && Ce(s, !l && ke(e, "script")),
                a
            },
        ...
        x.fn.extend({
            ...
            empty: function() {
                for (var e, t = 0; null != (e = this[t]); t++)
                    1 === e.nodeType && (x.cleanData(ke(e, !1)),
                    e.textContent = "");
                return this
            },
            clone: function(e, t) {
            ...
            html: function(e) {
                return G(this, (function(e) {
                    ...
                    if (void 0 === e && 1 === t.nodeType)
                        return t.innerHTML;
                    if ("string" == typeof e && !$e.test(e) && !Ae[(Te.exec(e) || ["", ""])[1].toLowerCase()]) {
                        e = x.htmlPrefilter(e);
                        try {
                            for (; n < i; n++)
                                1 === (t = this[n] || {}).nodeType && (x.cleanData(ke(t, !1)),
                                t.innerHTML = e);
                            t = 0
                        } catch (e) {}
                    }
            ...
            replaceWith: function() {
                ...
                return Be(this, arguments, (function(t) {
                    ...
                    x.inArray(this, e) < 0 && (x.cleanData(ke(this)),
        ...
        !function() {
            ...
            x.extend(h, {
                ...
                reliableTrDimensions: function() {
                    ...
                    fe.appendChild(t).appendChild(n).appendChild(i),
        ...
        function st(e, t, n, i, r, o) {
            ...
            if (n === (i ? "border" : "content"))
                return 0;
            for (; s < 4; s += 2)
                "margin" === n && (c += x.css(e, n + de[s], !0, r)),
                i ? ("content" === n && (l -= x.css(e, "padding" + de[s], !0, r)),
                "margin" !== n && (l -= x.css(e, "border" + de[s] + "Width", !0, r))) : (l += x.css(e, "padding" + de[s], !0, r),
                "padding" !== n ? l += x.css(e, "border" + de[s] + "Width", !0, r) : a += x.css(e, "border" + de[s] + "Width", !0, r));
        ...
        function at(e, t, n) {
            ...
            return (!h.boxSizingReliable() && r || !h.reliableTrDimensions() && E(e, "tr") || "auto" === s || !parseFloat(s) && "inline" === x.css(e, "display", !1, i)) && e.getClientRects().length && (r = "border-box" === x.css(e, "boxSizing", !1, i),
            (o = a in e) && (s = e[a])),
        ...
        x.extend({
            ...
            style: function(e, t, n, i) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var r, o, s, a = te(t), l = Ue.test(t), c = e.style;
                    if (l || (t = tt(a)),
                    s = x.cssHooks[t] || x.cssHooks[a],
                    void 0 === n)
                        return s && "get"in s && void 0 !== (r = s.get(e, !1, i)) ? r : c[t];
                    "string" == (o = typeof n) && (r = ue.exec(n)) && r[1] && (n = me(e, t, r),
                    o = "number"),
        ...
        x.each(["height", "width"], (function(e, t) {
            x.cssHooks[t] = {
                get: function(e, n, i) {
                    if (n)
                        return !nt.test(x.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? at(e, t, i) : Ye(e, it, (function() {
                            return at(e, t, i)
                        }
                        ))
                },
                set: function(e, n, i) {
                    var r, o = Xe(e), s = !h.scrollboxSize() && "absolute" === o.position, a = (s || i) && "border-box" === x.css(e, "boxSizing", !1, o), l = i ? st(e, t, i, a, o) : 0;
        ...
        function vt(e, t, n) {
            var i, r, o = 0, s = vt.prefilters.length, a = x.Deferred().always((function() {
                delete l.elem
            }
            )), l = function() {
                if (r)
                    return !1;
                for (var t = ct || pt(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), o = 0, s = c.tweens.length; o < s; o++)
                    c.tweens[o].run(i);
            ...
            for (function(e, t) {
                ...
                if (i = vt.prefilters[o].call(c, e, u, c.opts))
                    return p(i.stop) && (x._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
                    i;
            return x.map(u, mt, c),
        ...
        x.Animation = x.extend(vt, {
            ...
            prefilters: [function(e, t, n) {
                var i, r, o, s, a, l, c, u, d = "width"in t || "height"in t, f = this, h = {}, p = e.style, g = e.nodeType && ge(e), m = re.get(e, "fxshow");
                ...
                if ((l = !x.isEmptyObject(t)) || !x.isEmptyObject(h))
                    ...
                    l = !1,
                    h)
                        l || (m ? "hidden"in m && (g = m.hidden) : m = re.access(e, "fxshow", {
                            display: c
                        }),
                        o && (m.hidden = !g),
                        g && be([e], !0),
        ...
        x.fn.extend({
            ...
            finish: function(e) {
                return !1 !== e && (e = e || "fx"),
                this.each((function() {
                    var t, n = re.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = x.timers, s = i ? i.length : 0;
                    for (n.finish = !0,
                    x.queue(this, e, []),
            ...
            toggleClass: function(e, t) {
                ...
                this.each((function() {
                    if (a)
                        ...
                        void 0 !== e && "boolean" !== s || ((i = Tt(this)) && re.set(this, "__className__", i),
        ...
        x.extend(x.event, {
            trigger: function(t, n, i, r) {
                var o, s, a, l, c, d, f, h, v = [i || m], y = u.call(t, "type") ? t.type : t, b = u.call(t, "namespace") ? t.namespace.split(".") : [];
                if (s = h = a = i = i || m,
                3 !== i.nodeType && 8 !== i.nodeType && !Ot.test(y + x.event.triggered) && (y.indexOf(".") > -1 && (b = y.split("."),
                y = b.shift(),
                b.sort()),
                c = y.indexOf(":") < 0 && "on" + y,
                ...
                r || !f.trigger || !1 !== f.trigger.apply(i, n))) {
                    if (!r && !f.noBubble && !g(i)) {
                        ...
                        Ot.test(l + y) || (s = s.parentNode); s; s = s.parentNode)
                            v.push(s),
                            a = s;
                    ...
                    for (o = 0; (s = v[o++]) && !t.isPropagationStopped(); )
                        ...
                        (d = (re.get(s, "events") || Object.create(null))[t.type] && re.get(s, "handle")) && d.apply(s, n),
                        (d = c && s[c]) && d.apply && ne(s) && (t.result = d.apply(s, n),
                        !1 === t.result && t.preventDefault());
                    return t.type = y,
                    r || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(v.pop(), n) || !ne(i) || c && p(i[y]) && !g(i) && ((a = i[c]) && (i[c] = null),
                    x.event.triggered = y,
                    t.isPropagationStopped() && h.addEventListener(y, Dt),
                    i[y](),
                    t.isPropagationStopped() && h.removeEventListener(y, Dt),
        ...
        function $t(e, t, n, i) {
            ...
            if (Array.isArray(t))
                x.each(t, (function(t, r) {
                    n || jt.test(e) ? i(e, r) : $t(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
                }
                ));
        ...
        x.fn.extend({
            ...
            serializeArray: function() {
                return this.map((function() {
                    ...
                    var e = this.type;
                    return this.name && !x(this).is(":disabled") && Nt.test(this.nodeName) && !Pt.test(e) && (this.checked || !xe.test(e))
                }
                )).map((function(e, t) {
                    var n = x(this).val();
        ...
        x.extend({
            ...
            ajax: function(t, n) {
                ...
                t = void 0),
                n = n || {};
                var i, r, o, s, a, l, c, u, d, f, h = x.ajaxSetup({}, n), p = h.context || h, g = h.context && (p.nodeType || p.jquery) ? x(p) : x.event, v = x.Deferred(), y = x.Callbacks("once memory"), b = h.statusCode || {}, _ = {}, w = {}, T = "canceled", E = {
                    readyState: 0,
                ...
                r = h.url.replace(It, ""),
                h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ft, "+")) : (f = h.url.slice(r.length),
                h.data && (h.processData || "string" == typeof h.data) && (r += (St.test(r) ? "&" : "?") + h.data,
                delete h.data),
                ...
                E.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Vt + "; q=0.01" : "") : h.accepts["*"]),
                h.headers)
                ...
                function A(t, n, s, l) {
                    ...
                    d ? (h.ifModified && ((w = E.getResponseHeader("Last-Modified")) && (x.lastModified[r] = w),
                    (w = E.getResponseHeader("etag")) && (x.etag[r] = w)),
                    204 === t || "HEAD" === h.type ? T = "nocontent" : 304 === t ? T = "notmodified" : (T = _.state,
                    f = _.data,
                    d = !(m = _.error))) : (m = T,
                    !t && T || (T = "error",
                    t < 0 && (t = 0))),
                    E.status = t,
                    E.statusText = (n || T) + "",
                    d ? v.resolveWith(p, [f, T, E]) : v.rejectWith(p, [E, T, m]),
                    E.statusCode(b),
                    b = void 0,
                    u && g.trigger(d ? "ajaxSuccess" : "ajaxError", [E, h, d ? f : m]),
                    y.fireWith(p, [E, T]),
        ...
        x.ajaxSetup({
            ...
            jsonpCallback: function() {
                var e = Zt.pop() || x.expando + "_" + Ct.guid++;
                return this[e] = !0,
                e
            }
        }),
        x.ajaxPrefilter("json jsonp", (function(t, n, i) {
            ...
            if (a || "jsonp" === t.dataTypes[0])
                ...
                a ? t[a] = t[a].replace(Jt, "$1" + r) : !1 !== t.jsonp && (t.url += (St.test(t.url) ? "&" : "?") + t.jsonp + "=" + r),
        ...
        x.parseHTML = function(e, t, n) {
            ...
            o = !n && [],
            (r = I.exec(e)) ? [t.createElement(r[1])] : (r = Oe([e], t, o),
        ...
        x.offset = {
            setOffset: function(e, t, n) {
                var i, r, o, s, a, l, c = x.css(e, "position"), u = x(e), d = {};
            ...
            x.each({
                ...
                x.fn[i] = function(r, o) {
                    ...
                    return G(this, (function(t, n, r) {
                        ...
                        Math.max(t.body["scroll" + e], o["scroll" + e], t.body["offset" + e], o["offset" + e], o["client" + e])) : void 0 === r ? x.css(t, n, a) : x.style(t, n, r, a)
                    }
                    ), t, s ? r : void 0, s)
                }
            }
    ...
    */
    !function(e, t) {
        e.exports = function() {
            ...
            e)
              ...
              , u = e=>!(!e || "object" != typeof e) && (void 0 !== e.jquery && (e = e[0]),
            void 0 !== e.nodeType)
              , d = e=>u(e) ? e.jquery ? e[0] : e : "string" == typeof e && e.length > 0 ? document.querySelector(o(e)) : null
              , f = e=>{
              ...
              , x = (e,t=[],n=e)=>"function" == typeof e ? e(...t) : n
              , T = (e,t,n=!0)=>{
                if (!n)
                    return void x(e);
                const i = 5
            ...
            function q(e, t, n, i) {
                ...
                for (const [o,s] of Object.entries(r))
                    o.includes(i) && H(e, t, n, s.callable, s.delegationSelector)
            }
            function R(e) {
                return e = e.replace(k, ""),
                D[e] || e
            }
            const W = {
                on(e, t, n, i) {
                ...
                off(e, t, n, i) {
                    ...
                    if (void 0 === o) {
                        ...
                        for (const [n,i] of Object.entries(c)) {
                            const r = n.replace(C, "");
                            a && !t.includes(r) || H(e, l, s, i.callable, i.delegationSelector)
                        }
                    } else {
            ...
            const U = {
                ...
                getDataAttribute: (e,t)=>V(e.getAttribute(`data-bs-${z(t)}`))
            };
            class X {
                static get Default() {
                    return {}
                ...
                _mergeConfigObj(e, t) {
                    const n = u(t) ? U.getDataAttribute(t, "config") : {};
                    return {
                        ...this.constructor.Default,
                        ..."object" == typeof n ? n : {},
                        ...u(t) ? U.getDataAttributes(t) : {},
                        ..."object" == typeof e ? e : {}
                    }
                }
            ...
            class Q extends X {
                ...
                static getInstance(e) {
                    return t.get(d(e), this.DATA_KEY)
                }
            ...
            const K = e=>{
              ...
              , Z = (e,t="hide")=>{
                const n = `click.dismiss${e.EVENT_KEY}`
                  , i = e.NAME;
                W.on(document, n, `[data-bs-dismiss="${i}"]`, (function(n) {
                    if (["A", "AREA"].includes(this.tagName) && n.preventDefault(),
                    h(this))
                        return;
                    const r = G.getElementFromSelector(this) || this.closest(`.${i}`);
            ...
            class oe extends Q {
                ...
                close() {
                    if (W.trigger(this._element, te).defaultPrevented)
                        return;
            ...
            class Ee extends X {
                constructor(e, t) {
                    super(),
                    this._element = e,
                    e && Ee.isSupported() && (this._config = this._getConfig(t),
                    this._deltaX = 0,
                ...
                _initEvents() {
                    this._supportPointerEvents ? (W.on(this._element, me, (e=>this._start(e))),
                    W.on(this._element, ve, (e=>this._end(e))),
                    this._element.classList.add(_e)) : (W.on(this._element, he, (e=>this._start(e))),
                    W.on(this._element, pe, (e=>this._move(e))),
                    W.on(this._element, ge, (e=>this._end(e))))
                }
            ...
            const Ae = "carousel"
              ...
              , We = "active"
              , Be = "slide"
              , Ve = "carousel-item-end"
              , ze = "carousel-item-start"
              , Ue = "carousel-item-next"
              , Xe = "carousel-item-prev"
              , Ye = ".active"
              , Qe = ".carousel-item"
              , Ke = Ye + Qe
              , Ge = ".carousel-item img"
              , Ze = ".carousel-indicators"
              , Je = "[data-bs-slide], [data-bs-slide-to]"
              , et = '[data-bs-ride="carousel"]'
              , tt = {
                ArrowLeft: Le,
                ArrowRight: je
            }
            ...
            class rt extends Q {
                constructor(e, t) {
                    ...
                    this._indicatorsElement = G.findOne(Ze, this._element),
                ...
                _maybeEnableCycle() {
                    this._config.ride && (this._isSliding ? W.one(this._element, Ne, (()=>this.cycle())) : this.cycle())
                }
                to(e) {
                    ...
                    if (e > t.length - 1 || e < 0)
                        return;
                    if (this._isSliding)
                        return void W.one(this._element, Ne, (()=>this.to(e)));
                ...
                _addEventListeners() {
                    this._config.keyboard && W.on(this._element, $e, (e=>this._keydown(e))),
                    "hover" === this._config.pause && (W.on(this._element, Fe, (()=>this.pause())),
                    W.on(this._element, Ie, (()=>this._maybeEnableCycle()))),
                    this._config.touch && Ee.isSupported() && this._addTouchEventListeners()
                }
                _addTouchEventListeners() {
                    for (const e of G.find(Ge, this._element))
                        W.on(e, Me, (e=>e.preventDefault()));
                    const e = {
                        ...
                        endCallback: ()=>{
                            ...
                            this.touchTimeout = setTimeout((()=>this._maybeEnableCycle()), Se + this._config.interval))
                        }
                    };
                ...
                _setActiveIndicatorElement(e) {
                    if (!this._indicatorsElement)
                        return;
                    const t = G.findOne(Ye, this._indicatorsElement);
                ...
                _slide(e, t=null) {
                    ...
                    const n = this._getActive()
                      , i = e === Oe
                      , r = t || E(this._getItems(), n, i, this._config.wrap);
                    if (r === n)
                        return;
                    const o = this._getItemIndex(r)
                      , s = t=>W.trigger(this._element, t, {
                        relatedTarget: r,
                ...
                _getItems() {
                    return G.find(Qe, this._element)
                }
                _clearInterval() {
                ...
                _directionToOrder(e) {
                    return _() ? e === je ? De : Oe : e === je ? Oe : De
                }
                _orderToDirection(e) {
                    return _() ? e === De ? je : Le : e === De ? Le : je
                }
                static jQueryInterface(e) {
                    return this.each((function() {
            ...
            W.on(document, qe, Je, (function(e) {
                const t = G.getElementFromSelector(this);
                if (!t || !t.classList.contains(Re))
                    return;
                e.preventDefault();
                const n = rt.getOrCreateInstance(t)
                  , i = this.getAttribute("data-bs-slide-to");
                return i ? (n.to(i),
                void n._maybeEnableCycle()) : "next" === U.getDataAttribute(this, "slide") ? (n.next(),
            ...
            const ot = "collapse"
              ...
              , ct = `hide${st}`
              , ut = `hidden${st}`
              , dt = `click${st}.data-api`
              , ft = "show"
              , ht = "collapse"
              , pt = "collapsing"
              , gt = "collapsed"
              , mt = `:scope .${ht} .${ht}`
              , vt = "collapse-horizontal"
              , yt = "width"
              , bt = "height"
              , _t = ".collapse.show, .collapse.collapsing"
            ...
            class Et extends Q {
                ...
                show() {
                    if (this._isTransitioning || this._isShown())
                        return;
                    let e = [];
                    if (this._config.parent && (e = this._getFirstLevelChildren(_t).filter((e=>e !== this._element)).map((e=>Et.getOrCreateInstance(e, {
                        toggle: !1
                    })))),
                    e.length && e[0]._isTransitioning)
                        return;
                    if (W.trigger(this._element, at).defaultPrevented)
                        return;
                    for (const t of e)
                        t.hide();
                    ...
                    const n = ()=>{
                        ...
                        this._element.classList.add(ht, ft),
                        this._element.style[t] = "",
                        W.trigger(this._element, lt)
                    }
                ...
                hide() {
                    if (this._isTransitioning || !this._isShown())
                        return;
                    if (W.trigger(this._element, ct).defaultPrevented)
                        return;
                    const e = this._getDimension();
                    this._element.style[e] = `${this._element.getBoundingClientRect()[e]}px`,
                    m(this._element),
                    this._element.classList.add(pt),
                    this._element.classList.remove(ht, ft);
                ...
                _getDimension() {
                    return this._element.classList.contains(vt) ? yt : bt
                }
                _initializeChildren() {
                    if (!this._config.parent)
                        return;
                    const e = this._getFirstLevelChildren(wt);
                    for (const t of e) {
            ...
            W.on(document, dt, wt, (function(e) {
            ...
            var At = "top"
              ...
              , $t = "popper"
              , Ft = "reference"
              , It = Dt.reduce((function(e, t) {
                return e.concat([t + "-" + jt, t + "-" + Lt])
            }
            ), [])
              , Mt = [].concat(Dt, [Ot]).reduce((function(e, t) {
                return e.concat([t, t + "-" + jt, t + "-" + Lt])
            }
            ), [])
              , Ht = "beforeRead"
              , qt = "read"
            ...
            function Jt(e) {
                return "undefined" != typeof ShadowRoot && (e instanceof Kt(e).ShadowRoot || e instanceof ShadowRoot)
            }
            function en(e) {
                var t = e.state;
                Object.keys(t.elements).forEach((function(e) {
                    var n = t.styles[e] || {}
                      , i = t.attributes[e] || {}
                      , r = t.elements[e];
                    Zt(r) && Qt(r) && (Object.assign(r.style, n),
            ...
            function tn(e) {
                ...
                function() {
                    Object.keys(t.elements).forEach((function(e) {
                        ...
                        Zt(i) && Qt(i) && (Object.assign(i.style, o),
            ...
            function un(e, t, n) {
                ...
                var i = e.getBoundingClientRect()
                  , r = 1
                  , o = 1;
                t && Zt(e) && (r = e.offsetWidth > 0 && an(i.width) / e.offsetWidth || 1,
                o = e.offsetHeight > 0 && an(i.height) / e.offsetHeight || 1);
                var s = (Gt(e) ? Kt(e) : window).visualViewport
                  , a = !cn() && n
            ...
            function mn(e) {
                return "html" === Qt(e) ? e : e.assignedSlot || e.parentNode || (Jt(e) ? e.host : null) || gn(e)
            }
            function vn(e) {
                return Zt(e) && "fixed" !== hn(e).position ? e.offsetParent : null
            }
            function yn(e) {
                var t = /firefox/i.test(ln());
                if (/Trident/i.test(ln()) && Zt(e) && "fixed" === hn(e).position)
                    return null;
                var n = mn(e);
                for (Jt(n) && (n = n.host); Zt(n) && ["html", "body"].indexOf(Qt(n)) < 0; ) {
                    var i = hn(n);
            ...
            function bn(e) {
                for (var t = Kt(e), n = vn(e); n && pn(n) && "static" === hn(n).position; )
                    n = vn(n);
                return n && ("html" === Qt(n) || "body" === Qt(n) && "static" === hn(n).position) ? t : n || yn(e) || t
            }
            function _n(e) {
            ...
            var kn = function(e, t) {
                return En("number" != typeof (e = "function" == typeof e ? e(Object.assign({}, t.rects, {
                    placement: t.placement
                })) : e) ? e : An(e, Dt))
            };
            function Cn(e) {
                var t, n = e.state, i = e.name, r = e.options, o = n.elements.arrow, s = n.modifiersData.popperOffsets, a = rn(n.placement), l = _n(a), c = [St, Ct].indexOf(a) >= 0 ? "height" : "width";
                if (o && s) {
                    var u = kn(r.padding, n)
                      , d = dn(o)
                      , f = "y" === l ? At : St
                      , h = "y" === l ? kt : Ct
            ...
            function Sn(e) {
                ...
                null != i && ("string" != typeof i || (i = t.elements.popper.querySelector(i))) && fn(t.elements.popper, i) && (t.elements.arrow = i)
            }
            const On = {
                name: "arrow",
                enabled: !0,
            ...
            function Pn(e) {
                var t, n = e.popper, i = e.popperRect, r = e.placement, o = e.variation, s = e.offsets, a = e.position, l = e.gpuAcceleration, c = e.adaptive, u = e.roundOffsets, d = e.isFixed, f = s.x, h = void 0 === f ? 0 : f, p = s.y, g = void 0 === p ? 0 : p, m = "function" == typeof u ? u({
                    x: h,
                    y: g
                }) : {
                    x: h,
                ...
                if (c) {
                    var x = bn(n)
                      , T = "clientHeight"
                      , E = "clientWidth";
                    x === Kt(n) && "static" !== hn(x = gn(n)).position && "absolute" === a && (T = "scrollHeight",
                    E = "scrollWidth"),
                    (r === At || (r === St || r === Ct) && o === Lt) && (_ = kt,
                    g -= (d && x === w && w.visualViewport ? w.visualViewport.height : x[T]) - i.height,
                    g *= l ? 1 : -1),
                    r !== St && (r !== At && r !== kt || o !== Lt) || (b = Ct,
                    h -= (d && x === w && w.visualViewport ? w.visualViewport.width : x[E]) - i.width,
                    h *= l ? 1 : -1)
                }
                ...
                return h = C.x,
                g = C.y,
                l ? Object.assign({}, k, ((A = {})[_] = y ? "0" : "",
                A[b] = v ? "0" : "",
                A.transform = (w.devicePixelRatio || 1) <= 1 ? "translate(" + h + "px, " + g + "px)" : "translate3d(" + h + "px, " + g + "px, 0)",
                A)) : Object.assign({}, k, ((t = {})[_] = y ? g + "px" : "",
                t[b] = v ? h + "px" : "",
                t.transform = "",
                t))
            }
            function Nn(e) {
                ...
                null != t.modifiersData.popperOffsets && (t.styles.popper = Object.assign({}, t.styles.popper, Pn(Object.assign({}, c, {
                    offsets: t.modifiersData.popperOffsets,
                    position: t.options.strategy,
                    adaptive: s,
                    roundOffsets: l
                })))),
                null != t.modifiersData.arrow && (t.styles.arrow = Object.assign({}, t.styles.arrow, Pn(Object.assign({}, c, {
            ...
            function In(e) {
                ...
                a && l.addEventListener("resize", n.update, Fn),
                function() {
                    o && c.forEach((function(e) {
                        e.removeEventListener("scroll", n.update, Fn)
                    }
                    )),
                    a && l.removeEventListener("resize", n.update, Fn)
                }
            }
            const Mn = {
                name: "eventListeners",
            ...
            function Vn(e) {
                return un(gn(e)).left + Bn(e).scrollLeft
            }
            function zn(e, t) {
                var n = Kt(e)
                  , i = gn(e)
            ...
            function Un(e) {
                var t, n = gn(e), i = Bn(e), r = null == (t = e.ownerDocument) ? void 0 : t.body, o = on(n.scrollWidth, n.clientWidth, r ? r.scrollWidth : 0, r ? r.clientWidth : 0), s = on(n.scrollHeight, n.clientHeight, r ? r.scrollHeight : 0, r ? r.clientHeight : 0), a = -i.scrollLeft + Vn(e), l = -i.scrollTop;
                return "rtl" === hn(r || n).direction && (a += on(n.clientWidth, r ? r.clientWidth : 0) - o),
                {
                    width: o,
                    height: s,
                    x: a,
            ...
            function Yn(e) {
                return ["html", "body", "#document"].indexOf(Qt(e)) >= 0 ? e.ownerDocument.body : Zt(e) && Xn(e) ? e : Yn(mn(e))
            }
            function Qn(e, t) {
                var n;
                void 0 === t && (t = []);
                var i = Yn(e)
                  ...
                  , o = Kt(i)
                  , s = r ? [o].concat(o.visualViewport || [], Xn(i) ? i : []) : i
                  , a = t.concat(s);
                return r ? a : a.concat(Qn(mn(s)))
            }
            function Kn(e) {
            ...
            function Zn(e, t, n) {
                return t === Nt ? Kn(zn(e, n)) : Gt(t) ? Gn(t, n) : Kn(Un(gn(e)))
            }
            function Jn(e) {
                var t = Qn(mn(e))
                  , n = ["absolute", "fixed"].indexOf(hn(e).position) >= 0 && Zt(e) ? bn(e) : e;
                return Gt(n) ? t.filter((function(e) {
                    return Gt(e) && fn(e, n) && "body" !== Qt(e)
                }
                )) : []
            }
            function ei(e, t, n, i) {
                var r = "clippingParents" === t ? Jn(e) : [].concat(t)
                  , o = [].concat(r, [n])
                  , s = o[0]
                  , a = o.reduce((function(t, n) {
                    var r = Zn(e, n, i);
                    return t.top = on(r.top, t.top),
                    t.right = sn(r.right, t.right),
                    t.bottom = sn(r.bottom, t.bottom),
                    t.left = on(r.left, t.left),
                    t
                }
                ), Zn(e, s, i));
            ...
            function ti(e) {
                var t, n = e.reference, i = e.element, r = e.placement, o = r ? rn(r) : null, s = r ? Dn(r) : null, a = n.x + n.width / 2 - i.width / 2, l = n.y + n.height / 2 - i.height / 2;
                switch (o) {
                case At:
                    t = {
                        x: a,
            ...
            function ni(e, t) {
                ...
                var n = t
                  ...
                  , g = n.padding
                  , m = void 0 === g ? 0 : g
                  , v = En("number" != typeof m ? m : An(m, Dt))
                  , y = f === $t ? Ft : $t
                  , b = e.rects.popper
                  , _ = e.elements[p ? y : f]
                  , w = ei(Gt(_) ? _ : _.contextElement || gn(e.elements.popper), l, u, s)
                  , x = un(e.elements.reference)
                  , T = ti({
                    reference: x,
                    element: b,
                    strategy: "absolute",
                ...
                if (f === $t && C) {
                    ...
                    Object.keys(k).forEach((function(e) {
                        var t = [Ct, kt].indexOf(e) >= 0 ? 1 : -1
                          , n = [At, kt].indexOf(e) >= 0 ? "y" : "x";
                        k[e] += S[n] * t
                    }
                    ))
                }
            ...
            function oi(e) {
                ...
                if (!t.modifiersData[i]._skip) {
                    for (var r = n.mainAxis, o = void 0 === r || r, s = n.altAxis, a = void 0 === s || s, l = n.fallbackPlacements, c = n.padding, u = n.boundary, d = n.rootBoundary, f = n.altBoundary, h = n.flipVariations, p = void 0 === h || h, g = n.allowedAutoPlacements, m = t.options.placement, v = rn(m), y = l || (v !== m && p ? ri(m) : [qn(m)]), b = [m].concat(y).reduce((function(e, n) {
                        return e.concat(rn(n) === Ot ? ii(t, {
                            placement: n,
                            boundary: u,
                            rootBoundary: d,
                            padding: c,
                    ...
                    ), []), _ = t.rects.reference, w = t.rects.popper, x = new Map, T = !0, E = b[0], A = 0; A < b.length; A++) {
                        var k = b[A]
                          , C = rn(k)
                          , S = Dn(k) === jt
                          , O = [At, kt].indexOf(C) >= 0
            ...
            function li(e) {
                return [At, Ct, kt, St].some((function(t) {
                    return e[t] >= 0
                }
                ))
            }
            ...
            function fi(e) {
                var t = e.state
                  ...
                  , r = n.offset
                  , o = void 0 === r ? [0, 0] : r
                  , s = Mt.reduce((function(e, n) {
                    return e[n] = di(n, t.rects, o),
                    e
                }
                ), {})
                  , a = s[t.placement]
            ...
            function vi(e) {
                ...
                if (x) {
                    if (o) {
                        var O, D = "y" === _ ? At : St, j = "y" === _ ? kt : Ct, L = "y" === _ ? "height" : "width", P = x[_], N = P + m[D], $ = P - m[j], F = h ? -E[L] / 2 : 0, I = y === jt ? T[L] : E[L], M = y === jt ? -E[L] : -T[L], H = t.elements.arrow, q = h && H ? dn(H) : {
                            width: 0,
                            height: 0
                        }, R = t.modifiersData["arrow#persistent"] ? t.modifiersData["arrow#persistent"].padding : Tn(), W = R[D], B = R[j], V = wn(0, T[L], q[L]), z = b ? T[L] / 2 - F - V - W - k.mainAxis : I - V - W - k.mainAxis, U = b ? -T[L] / 2 + F + V + B + k.mainAxis : M + V + B + k.mainAxis, X = t.elements.arrow && bn(t.elements.arrow), Y = X ? "y" === _ ? X.clientTop || 0 : X.clientLeft || 0 : 0, Q = null != (O = null == C ? void 0 : C[_]) ? O : 0, K = P + U - Q, G = wn(h ? sn(N, P + z - Q - Y) : N, P, h ? on($, K) : $);
                        x[_] = G,
                        S[_] = G - P
                    }
                    if (a) {
                        var Z, J = "x" === _ ? At : St, ee = "x" === _ ? kt : Ct, te = x[w], ne = "y" === w ? "height" : "width", ie = te + m[J], re = te - m[ee], oe = -1 !== [At, St].indexOf(v), se = null != (Z = null == C ? void 0 : C[w]) ? Z : 0, ae = oe ? ie : te - T[ne] - E[ne] - se + k.altAxis, le = oe ? te + T[ne] + E[ne] - se - k.altAxis : re, ce = h && oe ? xn(ae, te, le) : wn(h ? ae : ie, te, h ? le : re);
                        x[w] = ce,
                        S[w] = ce - te
                    }
                    t.modifiersData[i] = S
            ...
            function _i(e) {
                return e !== Kt(e) && Zt(e) ? bi(e) : Bn(e)
            }
            function wi(e) {
                var t = e.getBoundingClientRect()
                  , n = an(t.width) / e.offsetWidth || 1
                  , i = an(t.height) / e.offsetHeight || 1;
                return 1 !== n || 1 !== i
            }
            function xi(e, t, n) {
                void 0 === n && (n = !1);
                ...
                return (i || !i && !n) && (("body" !== Qt(t) || Xn(o)) && (a = _i(t)),
                Zt(t) ? ((l = un(t, !0)).x += t.clientLeft,
                l.y += t.clientTop) : o && (l.x = Vn(o))),
                {
                    ...
                    var r = {
                      ...
                      , l = {
                        ...
                        setOptions: function(n) {
                            ...
                            r.scrollParents = {
                                reference: Gt(e) ? Qn(e) : e.contextElement ? Qn(e.contextElement) : [],
                                popper: Qn(t)
                            };
                            var a = Ei(ki([].concat(i, r.options.modifiers)));
                            return r.orderedModifiers = a.filter((function(e) {
                                return e.enabled
                            }
                            )),
                            c(),
                        ...
                        forceUpdate: function() {
                            if (!a) {
                                ...
                                if (Si(t, n)) {
                                    r.rects = {
                                        reference: xi(t, bn(n), "fixed" === r.options.strategy),
                                        popper: dn(n)
                                    },
                                    r.reset = !1,
            ...
            var Di = Oi()
              , ji = Oi({
                defaultModifiers: [Mn, gi, $n, nn]
            })
              , Li = Oi({
                defaultModifiers: [Mn, gi, $n, nn, hi, si, yi, On, ui]
            });
            const Pi = Object.freeze(Object.defineProperty({
              ...
              , ar = _() ? "top-end" : "top-start"
              , lr = _() ? "top-start" : "top-end"
              , cr = _() ? "bottom-end" : "bottom-start"
              , ur = _() ? "bottom-start" : "bottom-end"
              , dr = _() ? "left-start" : "right-start"
              , fr = _() ? "right-start" : "left-start"
              , hr = "top"
              , pr = "bottom"
              , gr = {
                autoClose: !0,
            ...
            class vr extends Q {
                constructor(e, t) {
                    ...
                    this._menu = G.next(this._element, ir)[0] || G.prev(this._element, ir)[0] || G.findOne(ir, this._parent),
                ...
                show() {
                    ...
                    if (!W.trigger(this._element, Vi, e).defaultPrevented) {
                        if (this._createPopper(),
                        "ontouchstart"in document.documentElement && !this._parent.closest(or))
                            for (const e of [].concat(...document.body.children))
                                W.on(e, "mouseover", g);
                        this._element.focus(),
                        this._element.setAttribute("aria-expanded", !0),
                        this._menu.classList.add(Qi),
                        this._element.classList.add(Qi),
                        W.trigger(this._element, zi, e)
                    }
                }
                hide() {
                    if (h(this._element) || !this._isShown())
                ...
                _completeHide(e) {
                    if (!W.trigger(this._element, Wi, e).defaultPrevented) {
                        if ("ontouchstart"in document.documentElement)
                            for (const e of [].concat(...document.body.children))
                                W.off(e, "mouseover", g);
                        this._popper && this._popper.destroy(),
                        this._menu.classList.remove(Qi),
                        this._element.classList.remove(Qi),
                        this._element.setAttribute("aria-expanded", "false"),
                        U.removeDataAttribute(this._menu, "popper"),
                        W.trigger(this._element, Bi, e)
                    }
                }
                _getConfig(e) {
                    if ("object" == typeof (e = super._getConfig(e)).reference && !u(e.reference) && "function" != typeof e.reference.getBoundingClientRect)
                ...
                _createPopper() {
                    ...
                    let e = this._element;
                    "parent" === this._config.reference ? e = this._parent : u(this._config.reference) ? e = d(this._config.reference) : "object" == typeof this._config.reference && (e = this._config.reference);
                    const t = this._getPopperConfig();
                    this._popper = Li(e, this._menu, t)
                }
                _isShown() {
                    return this._menu.classList.contains(Qi)
                }
                _getPlacement() {
                    const e = this._parent;
                    if (e.classList.contains(Gi))
                        return dr;
                    if (e.classList.contains(Zi))
                        return fr;
                    if (e.classList.contains(Ji))
                        return hr;
                    if (e.classList.contains(er))
                        return pr;
                    const t = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim();
                    return e.classList.contains(Ki) ? t ? lr : ar : t ? ur : cr
                }
                _detectNavbar() {
                    return null !== this._element.closest(rr)
                }
                _getOffset() {
                ...
                _selectMenuItem({key: e, target: t}) {
                    const n = G.find(sr, this._menu).filter((e=>f(e)));
                    n.length && E(n, t, e === qi, !n.includes(t)).focus()
                }
                static jQueryInterface(e) {
                    return this.each((function() {
                ...
                static clearMenus(e) {
                    if (e.button === Ri || "keyup" === e.type && e.key !== Mi)
                        return;
                    const t = G.find(nr);
                    for (const n of t) {
                        const t = vr.getInstance(n);
                        ...
                        if (i.includes(t._element) || "inside" === t._config.autoClose && !r || "outside" === t._config.autoClose && r)
                            continue;
                        if (t._menu.contains(e.target) && ("keyup" === e.type && e.key === Mi || /input|select|option|textarea|form/i.test(e.target.tagName)))
                            continue;
                        const o = {
                ...
                static dataApiKeydownHandler(e) {
                    const t = /input|textarea/i.test(e.target.tagName)
                      , n = e.key === Ii
                      , i = [Hi, qi].includes(e.key);
                    if (!i && !n)
                        return;
                    if (t && !n)
                        return;
                    e.preventDefault();
                    const r = this.matches(tr) ? this : G.prev(this, tr)[0] || G.next(this, tr)[0] || G.findOne(tr, e.delegateTarget.parentNode)
                      , o = vr.getOrCreateInstance(r);
                    if (i)
            ...
            W.on(document, Xi, tr, vr.dataApiKeydownHandler),
            W.on(document, Xi, ir, vr.dataApiKeydownHandler),
            W.on(document, Ui, vr.clearMenus),
            W.on(document, Yi, vr.clearMenus),
            W.on(document, Ui, tr, (function(e) {
                e.preventDefault(),
                vr.getOrCreateInstance(this).toggle()
            }
            )),
            w(vr);
            const yr = "backdrop"
            ...
            class Er extends X {
                ...
                hide(e) {
                    this._config.isVisible ? (this._getElement().classList.remove(_r),
                    this._emulateAnimation((()=>{
                        this.dispose(),
                        x(e)
                    }
                ...
                dispose() {
                    this._isAppended && (W.off(this._element, wr),
                    this._element.remove(),
                    this._isAppended = !1)
                }
                _getElement() {
                    if (!this._element) {
                        ...
                        this._config.isAnimated && e.classList.add(br),
                        this._element = e
                    }
            ...
            class Nr extends X {
                ...
                activate() {
                    ...
                    W.off(document, kr),
                    W.on(document, Cr, (e=>this._handleFocusin(e))),
                    W.on(document, Sr, (e=>this._handleKeydown(e))),
                    this._isActive = !0)
                }
                deactivate() {
                ...
                _handleFocusin(e) {
                    ...
                    0 === n.length ? t.focus() : this._lastTabNavDirection === jr ? n[n.length - 1].focus() : n[0].focus()
                }
                _handleKeydown(e) {
                    e.key === Or && (this._lastTabNavDirection = e.shiftKey ? jr : Dr)
                }
            }
            ...
            class Hr {
                ...
                hide() {
                    ...
                    this._setElementAttributes(this._element, Ir, (t=>t + e)),
                    this._setElementAttributes($r, Ir, (t=>t + e)),
                    this._setElementAttributes(Fr, Mr, (t=>t - e))
                }
                reset() {
                    this._resetElementAttributes(this._element, "overflow"),
                    this._resetElementAttributes(this._element, Ir),
                    this._resetElementAttributes($r, Ir),
                    this._resetElementAttributes(Fr, Mr)
                }
                isOverflowing() {
                ...
                _resetElementAttributes(e, t) {
                    const n = e=>{
                        ...
                        null !== n ? (U.removeDataAttribute(e, t),
                ...
                _applyManipulationCallback(e, t) {
                    if (u(e))
                        ...
                        for (const n of G.find(e, this._element))
                            t(n)
                }
            }
            const qr = "modal"
              ...
              , Yr = `resize${Rr}`
              , Qr = `click.dismiss${Rr}`
              , Kr = `mousedown.dismiss${Rr}`
              , Gr = `keydown.dismiss${Rr}`
              , Zr = `click${Rr}.data-api`
              , Jr = "modal-open"
              , eo = "fade"
              , to = "show"
              , no = "modal-static"
            ...
            class co extends Q {
                constructor(e, t) {
                    super(e, t),
                    this._dialog = G.findOne(ro, this._element),
                ...
                show(e) {
                    this._isShown || this._isTransitioning || W.trigger(this._element, Ur, {
                        relatedTarget: e
                ...
                hide() {
                    this._isShown && !this._isTransitioning && (W.trigger(this._element, Br).defaultPrevented || (this._isShown = !1,
                    this._isTransitioning = !0,
                ...
                _showElement(e) {
                    ...
                    const t = G.findOne(oo, this._dialog);
                    t && (t.scrollTop = 0),
                    m(this._element),
                ...
                _addEventListeners() {
                    W.on(this._element, Gr, (e=>{
                        e.key === Wr && (this._config.keyboard ? this.hide() : this._triggerBackdropTransition())
                    }
                    )),
                    W.on(window, Yr, (()=>{
                    ...
                    W.on(this._element, Kr, (e=>{
                        W.one(this._element, Qr, (t=>{
                ...
                _triggerBackdropTransition() {
                    if (W.trigger(this._element, Vr).defaultPrevented)
                        return;
                    const e = this._element.scrollHeight > document.documentElement.clientHeight
                      , t = this._element.style.overflowY;
                    "hidden" === t || this._element.classList.contains(no) || (e || (this._element.style.overflowY = "hidden"),
                ...
                static jQueryInterface(e, t) {
                    return this.each((function() {
                        const n = co.getOrCreateInstance(this, e);
                        if ("string" == typeof e) {
                            if (void 0 === n[e])
                                throw new TypeError(`No method named "${e}"`);
                            n[e](t)
            ...
            W.on(document, Zr, so, (function(e) {
                const t = G.getElementFromSelector(this);
                ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
                W.one(t, Ur, (e=>{
                    e.defaultPrevented || W.one(t, zr, (()=>{
                        f(this) && this.focus()
                    }
                    ))
                }
                ));
                const n = G.findOne(io);
                n && co.getInstance(n).hide(),
                co.getOrCreateInstance(t).toggle(this)
            }
            )),
            Z(co),
            w(co);
            const uo = "offcanvas"
              ...
              , ko = `resize${fo}`
              , Co = `click${fo}${ho}`
              , So = `keydown.dismiss${fo}`
              , Oo = '[data-bs-toggle="offcanvas"]'
              , Do = {
                backdrop: !0,
                keyboard: !0,
                scroll: !1
            ...
            class Lo extends Q {
                ...
                hide() {
                    if (!this._isShown)
                        return;
                    if (W.trigger(this._element, To).defaultPrevented)
                        return;
                    this._focustrap.deactivate(),
                    this._element.blur(),
                    this._isShown = !1,
                    ...
                    this._backdrop.hide();
                    const e = ()=>{
                        this._element.classList.remove(mo, yo),
                        this._element.removeAttribute("aria-modal"),
                        this._element.removeAttribute("role"),
                        this._config.scroll || (new Hr).reset(),
                        W.trigger(this._element, Ao)
                    }
                    ;
                ...
                _initializeBackDrop() {
                    const e = ()=>{
                        "static" !== this._config.backdrop ? this.hide() : W.trigger(this._element, Eo)
                    }
                ...
                _addEventListeners() {
                    W.on(this._element, So, (e=>{
                        e.key === go && (this._config.keyboard ? this.hide() : W.trigger(this._element, Eo))
                    }
                    ))
                }
                static jQueryInterface(e) {
            ...
            W.on(document, Co, Oo, (function(e) {
                const t = G.getElementFromSelector(this);
                ...
                const n = G.findOne(_o);
                n && n !== t && Lo.getInstance(n).hide(),
                Lo.getOrCreateInstance(t).toggle(this)
            }
            )),
            W.on(window, po, (()=>{
                for (const e of G.find(_o))
                    Lo.getOrCreateInstance(e).show()
            }
            )),
            W.on(window, ko, (()=>{
                for (const e of G.find("[aria-modal][class*=show][class*=offcanvas-]"))
                    "fixed" !== getComputedStyle(e).position && Lo.getOrCreateInstance(e).hide()
            }
            )),
            Z(Lo),
            w(Lo);
            const Po = {
              ...
              , No = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
              , $o = /^(?!javascript:)(?:[a-z0-9+.-]+:|[^&:/?#]*(?:[/?#]|$))/i
              , Fo = (e,t)=>{
                const n = e.nodeName.toLowerCase();
                return t.includes(n) ? !No.has(n) || Boolean($o.test(e.nodeValue)) : t.filter((e=>e instanceof RegExp)).some((e=>e.test(n)))
            }
            ;
            function Io(e, t, n) {
                if (!e.length)
                ...
                for (const e of r) {
                    ...
                    const i = [].concat(...e.attributes)
                      , r = [].concat(t["*"] || [], t[n] || []);
                    for (const t of i)
                        Fo(t, r) || e.removeAttribute(t.nodeName)
                }
                return i.body.innerHTML
            }
            const Mo = "TemplateFactory"
              , Ho = {
                allowList: Po,
                content: {},
                extraClass: "",
            ...
            class Wo extends X {
                ...
                _setContent(e, t, n) {
                    const i = G.findOne(n, e);
                    i && ((t = this._resolvePossibleFunction(t)) ? u(t) ? this._putElementInTemplate(d(t), i) : this._config.html ? i.innerHTML = this._maybeSanitize(t) : i.textContent = t : i.remove())
                }
                _maybeSanitize(e) {
                    return this._config.sanitize ? Io(e, this._config.allowList, this._config.sanitizeFn) : e
                }
            ...
            const Bo = "tooltip"
              , Vo = new Set(["sanitize", "allowList", "sanitizeFn"])
              , zo = "fade"
              , Uo = "show"
              , Xo = ".tooltip-inner"
              , Yo = ".modal"
            ...
            class hs extends Q {
                ...
                dispose() {
                    ...
                    W.off(this._element.closest(Yo), Qo, this._hideModalHandler),
                ...
                show() {
                    ...
                    if (!this._isWithContent() || !this._isEnabled)
                        return;
                    const e = W.trigger(this._element, this.constructor.eventName(ns))
                    ...
                    W.trigger(this._element, this.constructor.eventName(rs))),
                    ...
                    "ontouchstart"in document.documentElement)
                        for (const e of [].concat(...document.body.children))
                            W.on(e, "mouseover", g);
                    const r = ()=>{
                        W.trigger(this._element, this.constructor.eventName(is)),
                ...
                hide() {
                    if (!this._isShown())
                        return;
                    if (W.trigger(this._element, this.constructor.eventName(es)).defaultPrevented)
                        return;
                    if (this._getTipElement().classList.remove(Uo),
                    "ontouchstart"in document.documentElement)
                        for (const e of [].concat(...document.body.children))
                            W.off(e, "mouseover", g);
                    ...
                    const e = ()=>{
                        ...
                        W.trigger(this._element, this.constructor.eventName(ts)))
                    }
                    ;
                ...
                _getTemplateFactory(e) {
                    return this._templateFactory ? this._templateFactory.changeContent(e) : this._templateFactory = new Wo({
                        ...this._config,
                        content: e,
                ...
                _isShown() {
                    return this.tip && this.tip.classList.contains(Uo)
                }
                _createPopper(e) {
                    const t = x(this._config.placement, [this, e, this._element])
                      , n = us[t.toUpperCase()];
                    return Li(this._element, e, this._getPopperConfig(n))
                }
                _getOffset() {
                    const {offset: e} = this._config;
                    return "string" == typeof e ? e.split(",").map((e=>Number.parseInt(e, 10))) : "function" == typeof e ? t=>e(t, this._element) : e
                ...
                _setListeners() {
                    ...
                    for (const t of e)
                        if ("click" === t)
                            W.on(this._element, this.constructor.eventName(os), this._config.selector, (e=>{
                                this._initializeOnDelegatedTarget(e).toggle()
                            }
                            ));
                        else if (t !== Jo) {
                            const e = t === Ko ? this.constructor.eventName(ls) : this.constructor.eventName(ss)
                              , n = t === Ko ? this.constructor.eventName(cs) : this.constructor.eventName(as);
                            W.on(this._element, e, this._config.selector, (e=>{
                                const t = this._initializeOnDelegatedTarget(e);
                                t._activeTrigger["focusin" === e.type ? Go : Ko] = !0,
                                t._enter()
                            }
                            )),
                            W.on(this._element, n, this._config.selector, (e=>{
                                const t = this._initializeOnDelegatedTarget(e);
                                t._activeTrigger["focusout" === e.type ? Go : Ko] = t._element.contains(e.relatedTarget),
                                t._leave()
                            }
                            ))
                        }
                    ...
                    ,
                    W.on(this._element.closest(Yo), Qo, this._hideModalHandler)
                }
                _fixTitle() {
            ...
            const _s = "scrollspy"
              ...
              , As = "dropdown-item"
              , ks = "active"
              , Cs = '[data-bs-spy="scroll"]'
              , Ss = "[href]"
              , Os = ".nav, .list-group"
              , Ds = ".nav-link"
              , js = `${Ds}, .nav-item > ${Ds}, .list-group-item`
              , Ls = ".dropdown"
              , Ps = ".dropdown-toggle"
              , Ns = {
                offset: null,
            ...
            class Fs extends Q {
                ...
                _maybeEnableSmoothScroll() {
                    this._config.smoothScroll && (W.off(this._config.target, Ts),
                    W.on(this._config.target, Ts, Ss, (e=>{
                ...
                _initializeTargetsAndObservables() {
                    this._targetLinks = new Map,
                    this._observableSections = new Map;
                    const e = G.find(Ss, this._config.target);
                    for (const t of e) {
                        if (!t.hash || h(t))
                            continue;
                        const e = G.findOne(decodeURI(t.hash), this._element);
                        f(e) && (this._targetLinks.set(decodeURI(t.hash), t),
                ...
                _process(e) {
                    ...
                    W.trigger(this._element, xs, {
                        relatedTarget: e
                    }))
                }
                _activateParents(e) {
                    if (e.classList.contains(As))
                        G.findOne(Ps, e.closest(Ls)).classList.add(ks);
                    else
                        for (const t of G.parents(e, Os))
                            for (const e of G.prev(t, js))
                                e.classList.add(ks)
                }
                _clearActiveClass(e) {
                    e.classList.remove(ks);
                    const t = G.find(`${Ss}.${ks}`, e);
                    for (const e of t)
                        e.classList.remove(ks)
                }
                static jQueryInterface(e) {
            ...
            W.on(window, Es, (()=>{
                for (const e of G.find(Cs))
                    Fs.getOrCreateInstance(e)
            }
            )),
            w(Fs);
            const Is = "tab"
              ...
              , oa = '.list-group, .nav, [role="tablist"]'
              , sa = ".nav-item, .list-group-item"
              , aa = '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]'
              , la = `.nav-link${ra}, .list-group-item${ra}, [role="tab"]${ra}, ${aa}`
              , ca = `.${Zs}[data-bs-toggle="tab"], .${Zs}[data-bs-toggle="pill"], .${Zs}[data-bs-toggle="list"]`;
            class ua extends Q {
                constructor(e) {
                    super(e),
                    this._parent = this._element.closest(oa),
                    this._parent && (this._setInitialAttributes(this._parent, this._getChildren()),
                    W.on(this._element, Vs, (e=>this._keydown(e))))
                }
                static get NAME() {
                    return Is
                }
                ...
                _activate(e, t) {
                    if (!e)
                        return;
                    e.classList.add(Zs),
                    this._activate(G.getElementFromSelector(e));
                    const n = ()=>{
                    ...
                    ;
                    this._queueCallback(n, e, e.classList.contains(Js))
                }
                _deactivate(e, t) {
                    if (!e)
                        return;
                ...
                _keydown(e) {
                    if (![Us, Xs, Ys, Qs, Ks, Gs].includes(e.key))
                        return;
                    e.stopPropagation(),
                    e.preventDefault();
                    const t = this._getChildren().filter((e=>!h(e)));
                    let n;
                    if ([Ks, Gs].includes(e.key))
                        n = t[e.key === Ks ? 0 : t.length - 1];
                    else {
                        const i = [Xs, Qs].includes(e.key);
                        n = E(t, e.target, i, !0)
                    }
                    n && (n.focus({
                        preventScroll: !0
                    }),
                    ua.getOrCreateInstance(n).show())
                }
                _getChildren() {
                    return G.find(la, this._parent)
                }
                _getActiveElem() {
                ...
                _getInnerElement(e) {
                    return e.matches(la) ? e : G.findOne(la, e)
                }
                _getOuterElement(e) {
                    return e.closest(sa) || e
                }
                static jQueryInterface(e) {
                    return this.each((function() {
                        const t = ua.getOrCreateInstance(this);
                        if ("string" == typeof e) {
                            if (void 0 === t[e] || e.startsWith("_") || "constructor" === e)
                                throw new TypeError(`No method named "${e}"`);
                            t[e]()
            ...
            W.on(document, Bs, aa, (function(e) {
                ["A", "AREA"].includes(this.tagName) && e.preventDefault(),
                h(this) || ua.getOrCreateInstance(this).show()
            }
            )),
            W.on(window, zs, (()=>{
                for (const e of G.find(ca))
                    ua.getOrCreateInstance(e)
            }
            )),
            w(ua);
            const da = "toast"
            ...
            class Ca extends Q {
                ...
                show() {
                    if (W.trigger(this._element, ba).defaultPrevented)
                        return;
                    this._clearTimeout(),
                    this._config.animation && this._element.classList.add(wa);
                    const e = ()=>{
                        this._element.classList.remove(Ea),
                        W.trigger(this._element, _a),
                        this._maybeScheduleHide()
                    }
                    ;
                    this._element.classList.remove(xa),
                    m(this._element),
                    this._element.classList.add(Ta, Ea),
                    this._queueCallback(e, this._element, this._config.animation)
                }
                hide() {
                    if (!this.isShown())
                        return;
                    if (W.trigger(this._element, va).defaultPrevented)
                        return;
                    const e = ()=>{
                        this._element.classList.add(xa),
                        this._element.classList.remove(Ea, Ta),
                        W.trigger(this._element, ya)
                    }
                    ;
                ...
                _setListeners() {
                    W.on(this._element, ha, (e=>this._onInteraction(e, !0))),
                    W.on(this._element, pa, (e=>this._onInteraction(e, !1))),
                    W.on(this._element, ga, (e=>this._onInteraction(e, !0))),
                    W.on(this._element, ma, (e=>this._onInteraction(e, !1)))
                }
                _clearTimeout() {
                    clearTimeout(this._timeout),
                    this._timeout = null
    ...
    !function(e) {
        var t = function(e) {
            var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i
              ...
              , r = {
                    ...
                    DFS: function e(t, n, i, o) {
                        ...
                        for (var a in t)
                            if (t.hasOwnProperty(a)) {
                                ...
                                var l = t[a]
                                  , c = r.util.type(l);
                                "Object" !== c || o[s(l)] ? "Array" !== c || o[s(l)] || (o[s(l)] = !0,
                                e(l, n, a, o)) : (o[s(l)] = !0,
                                e(l, n, null, o))
                            }
                    }
                ...
                highlightElement: function(t, n, i) {
                    ...
                    (a = l.element.parentElement) && "pre" === a.nodeName.toLowerCase() && !a.hasAttribute("tabindex") && a.setAttribute("tabindex", "0"),
                    !l.code)
                        return r.hooks.run("complete", l),
                        void (i && i.call(l.element));
                    ...
                    l.grammar)
                        if (n && e.Worker) {
                            ...
                            c(r.highlight(l.code, l.grammar, l.language));
                    else
                        c(r.util.encode(l.code))
                },
                ...
                for (var f in n)
                    if (n.hasOwnProperty(f) && n[f]) {
                        ...
                        for (var p = 0; p < h.length; ++p) {
                            ...
                            for (var w = g.pattern || g, x = i.next, T = l; x !== t.tail && !(d && T >= d.reach); T += x.value.length,
                            x = x.next) {
                                var E = x.value;
                                ...
                                if (!(E instanceof o)) {
                                    var A, k = 1;
                                    if (y) {
                                        if (!(A = s(w, T, e, v)) || A.index >= e.length)
                                            break;
                                        var C = A.index
                                          , S = A.index + A[0].length
                                          , O = T;
                                        for (O += x.value.length; C >= O; )
                                            O += (x = x.next).value.length;
                                        if (T = O -= x.value.length,
                                        x.value instanceof o)
                                            continue;
                                        for (var D = x; D !== t.tail && (O < S || "string" == typeof D.value); D = D.next)
                                            k++,
                                            O += D.value.length;
                                        k--,
                                        E = e.slice(T, O),
                                    ...
                                    T += L.length),
                                    u(t, $, k),
                                    x = c(t, $, new o(f,m ? r.tokenize(j, m) : j,b,j)),
                                    P && c(t, x, P),
                                    k > 1) {
                                        var F = {
                                            cause: f + "," + p,
            ...
            function u(e, t, n) {
                for (var i = t.next, r = 0; r < n && i !== e.tail; r++)
                    i = i.next;
                t.next = i,
                i.prev = t,
                e.length -= r
    ...
    w((function() {
        var e = new m;
        e.start(),
        e.addEventListener("secondsUpdated", (function(t) {
            w("#basicUsage").html(e.getTimeValues().toString())
        }
        ))
    }
    )),
    w((function() {
        ...
        e.addEventListener("secondsUpdated", (function(t) {
            w("#gettingValuesExample .days").html(e.getTimeValues().days),
            w("#gettingValuesExample .hours").html(e.getTimeValues().hours),
            w("#gettingValuesExample .minutes").html(e.getTimeValues().minutes),
            w("#gettingValuesExample .seconds").html(e.getTimeValues().seconds),
            w("#gettingValuesExample .secondTenths").html(e.getTimeValues().secondTenths),
            w("#gettingTotalValuesExample .days").html(e.getTotalTimeValues().days),
            w("#gettingTotalValuesExample .hours").html(e.getTotalTimeValues().hours),
            w("#gettingTotalValuesExample .minutes").html(e.getTotalTimeValues().minutes),
            w("#gettingTotalValuesExample .seconds").html(e.getTotalTimeValues().seconds),
            w("#gettingTotalValuesExample .secondTenths").html(e.getTotalTimeValues().secondTenths)
        }
        ))
    }
    )),
    w((function() {
        var e = new m;
        w("#chronoExample .startButton").click((function() {
            e.start()
        }
        )),
        w("#chronoExample .pauseButton").click((function() {
            e.pause()
        }
        )),
        w("#chronoExample .stopButton").click((function() {
            e.stop()
        }
        )),
        w("#chronoExample .resetButton").click((function() {
            e.reset()
        }
        )),
        e.addEventListener("secondsUpdated", (function(t) {
            w("#chronoExample .values").html(e.getTimeValues().toString())
        }
        )),
        e.addEventListener("started", (function(t) {
            w("#chronoExample .values").html(e.getTimeValues().toString())
        }
        )),
    ...
    w((function() {
        ...
        w("#startValuesAndTargetExample .values").html(e.getTimeValues().toString()),
        e.addEventListener("secondsUpdated", (function(t) {
            w("#startValuesAndTargetExample .values").html(e.getTimeValues().toString()),
            w("#startValuesAndTargetExample .progress_bar").html(w("#startValuesAndTargetExample .progress_bar").html() + ".")
        }
        )),
        e.addEventListener("targetAchieved", (function(e) {
            w("#startValuesAndTargetExample .progress_bar").html("COMPLETE!!")
        }
        ))
    }
    )),
    w((function() {
        ...
        w("#countdownExample .values").html(e.getTimeValues().toString()),
        e.addEventListener("secondsUpdated", (function(t) {
            w("#countdownExample .values").html(e.getTimeValues().toString())
        }
        )),
        e.addEventListener("targetAchieved", (function(e) {
            w("#countdownExample .values").html("KABOOM!!")
        }
        ))
    }
    )),
    w((function() {
        (new m).start({
            callback: function(e) {
                w("#callbackExample .values").html("Hello, I am a callback and I am counting time: " + e.getTimeValues().toString(["days", "hours", "minutes", "seconds", "secondTenths"]))
            }
        })
    }
    )),
    w((function() {
        ...
        e.addEventListener("secondTenthsUpdated", (function(t) {
            w("#secondTenthsExample .values").html(e.getTimeValues().toString(["hours", "minutes", "seconds", "secondTenths"]))
        }
        ))
    }
    )),
    w((function() {
        ...
        w("#defaultParamsExample .values").html(e.getTimeValues().toString()),
        e.addEventListener("secondsUpdated", (function(t) {
            w("#defaultParamsExample .values").html(e.getTimeValues().toString())
        }
        )),
        e.addEventListener("targetAchieved", (function(e) {
            w("#defaultParamsExample .values").html("The bomb has been defused!")
        }
        ))
    }
    ))
